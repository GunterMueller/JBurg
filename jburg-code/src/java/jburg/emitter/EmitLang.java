...
public interface EmitLang
{
     ...
     * @return an instance of the StringTemplate.
     */
    abstract public StringTemplate getTemplate(String name, Object ... attrValue);
	 ...
	 * @param output
	 */
	abstract public void emitHeader(String packageName, String headerBlock, String baseClassName, List<String> InterfaceNames, PrintStream output);
	 ...
	 */
	abstract public void emitInclass(List<? extends Object> inclassBlocks, PrintStream output);
	 ...
	 *  @return a code snippet that represents the code in the target language that declares
	 *  a variable and initializes it from the value stack, thus emulating a parameter declaration;
     *  this variant emits a variadic parameter.
	 *  @param stackName - name of the stack.
	 *  @param paramType - the "parameter" type.
	 *  @param paramName - the "parameter's" name.
	 */
	abstract public Object genVariadicActionRoutineParameter(Object stackName, Object paramType, Object paramName);
	 ...
	 *    reasonably generic, e.g., java.util.Stack on Java implementations, std::stack&lt;ReducerIntermediateResult&gt; in C++.
	 ...
	 *   container type, e.g., java.util.Vector or std::vector&lt;ReducerIntermediateResult&gt;
	 */
     ...
     */
    abstract public StringTemplate getConstructorBody(Object decl, Object baseClass, Object ... superParameters);

    /**
     * @return the name of the routine that appends to an n-ary list.
     */
    abstract public StringTemplate getNarySubtreeAdd();
    ...
    abstract public String getStringClassName();

    abstract public Object getStringIntConcat(Object strArg, Object intArg);

    abstract public Object defineContainer(Object contentsType);

    abstract public Object getAddChild();

    abstract public Object getReferenceType(Object baseType);
}
